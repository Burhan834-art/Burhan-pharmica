...
const Heading = () => {
  ...
  return (
    <>
     <motion.h1
          className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-extrabold text-white tracking-tight drop-shadow-lg shine-effect capitalize"
          initial="hidden"
          animate="visible"
        >
          {[
            ...
            <motion.span
              key={index}
              className="block xl:text-6xl lg:text-5xl md:text-4xl"
