  ...
  return (
    <div className="container mx-auto px-4 my-20">
      ...
      <div className="text-center mb-10">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-gray-800 mb-8">
          Our Policies
        </h1>
      ...
      {isMobile ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {policies.map((policy, index) => (
            ...
            >
              <h2 className="text-xl lg:text-3xl xl:text-3xl md:text-2xl font-semibold mb-4 text-gray-800">
                {policy.title}
              </h2>
